...
const MyStaffPage = ({}) => {
    const { id } = useParams();
    console.log(id);
    const { data, isLoading } = useFetchEmployeeQuery(id, {
    ...
    console.log(data.employee.employee_details.bank_name);
                    ...
                    <Col span={24}>
                        <Form.Item label="Profile Picture">
                            {employee.employee_details?.emp_picture ? (
                                <img
                                    src={`public/${employee.employee_details.emp_picture}`}
                                    alt="Profile"
                                    width="100px"
                                    height="100px"
                                />
