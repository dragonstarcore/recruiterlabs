...
// export default function OperatingSystem({ items }) {
//     const chartData = {
...
//                 height: 350,
//             },
//             labels: items.map((item) => item.operatingSystem),
//             title: {
//                 text: "Screen Page Views by Operating System",
//                 align: "left",
//             },
//             legend: {
//                 position: "bottom",
...
export default function OperatingSystem({ items }) {
    useLayoutEffect(() => {
        ...
        pieSeries.dataFields.category = "operatingSystem";
