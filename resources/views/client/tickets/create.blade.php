                ...
                <div class="card-body">
                    <form action="{{route('tickets.store')}}" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <select name="team" class="form-control form-control-select2" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <textarea name="description" rows="3" cols="3" class="form-control" placeholder="Enter description here" required>{{old('description')}}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <textarea name="message" rows="3" cols="3" class="form-control" placeholder="Enter your message here" required>{{old('message')}}</textarea>
