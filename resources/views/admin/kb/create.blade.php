        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Create Document/Video/FAQ</h5>
                </div>
                ...
                <div class="card-body">
                    <form action="{{route('knowledgebases.store')}}" method="post" enctype="multipart/form-data" id="target">
                        ...
                        <div class="row mb-3 QA" style="display:none">
                            ...
                            <div class="col-lg-9">
                                <textarea name="answer" type="text" class="form-control" placeholder="Answer" value="{{old('answer')}}" required style="height: 300px !important;"></textarea>
