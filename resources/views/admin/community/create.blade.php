                ...
                <div class="card-body">
                    <form action="{{route('communities.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input name="industry" type="text" class="form-control" placeholder="Industry" value="{{old('industry')}}" required>
                        ...
                        {{-- <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input name="specialist" type="text" class="form-control" placeholder="PHP Developer" value="{{old('specialist')}}" required>
