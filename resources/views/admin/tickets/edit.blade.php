            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('tickets.update',$ticket->id)}}" method="post">
                        ...
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Team: <span class="requiredData">*</span></label>
                            <div class="col-lg-9">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input name="title" type="text" class="form-control" placeholder="Title" value="{{$ticket->title}}" required>
                                @if($errors->has('title'))
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <textarea name="description" rows="3" cols="3" class="form-control" placeholder="Enter description here" required>{{$ticket->description}}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <select name="status" class="form-control form-control-select2" required>
                                    ...
                                    <option value="1" @if ($ticket->status==1) selected @endif>Active</option>
                                    <option value="0" @if ($ticket->status==0) selected @endif>Inactive</option>
                                </select>
