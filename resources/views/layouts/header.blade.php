    ...
    <div class="container-fluid">
        ...
        <div class="navbar-brand flex-1 flex-lg-0">
            <a href="{{ route('home') }}" class="d-inline-flex align-items-center">
                ...
                {{-- <img src="{{asset('assets/images/RL Blue Logo (1).png')}}" class="d-none d-sm-inline-block h-56px ms-3" alt=""> --}}
                @if(isset(auth()->user()->user_details->logo) && auth()->user()->user_details->logo!=null)
                    <img src="{{asset(''.auth()->user()->user_details->logo)}}" class="d-none d-sm-inline-block h-56px ms-3" alt="">
                @else
            ...
            <li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
                <a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
                    <div class="status-indicator-container">
                        <img src="{{asset('assets/images/default_user.jpg')}}" class="w-32px h-32px rounded-pill" alt="A">
                        <span class="status-indicator bg-success"></span>
                    </div>
